<template>
    <Panel header="Connected Players">
        <TransitionGroup name="list">
            <div v-for="(player, index) in lobbySettings?.playerList" :key="index">
                <div class="player">
                    <div class="flex flex-col">
                        <!-- Append admin star if player is admin. -->
                        <svg v-if="lobbySettings?.admin === index" class="h-3 lg:h-4 m-auto" xmlns="http://www.w3.org/2000/svg" fill="gold" viewBox="0 0 256 256">
